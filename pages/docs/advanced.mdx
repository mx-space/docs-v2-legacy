...
export const Configurator = ({ args, template, env }) => {
  ...
  return (
    <div>
      ...
      <div id="config" className={clsx(
        "border rounded-lg overflow-hidden h-12 mb-4",
        ...
        <div className={clsx(
          "flex cursor-pointer items-center justify-between bg-gray-100 p-4",
          "dark:bg-gray-700"
        )} onClick={() => {
          ...
          <h2 className={clsx(
            ...
            <span className="text-black dark:text-white">ecosystem.config.js</span> 配置文件 (点击展开)
          </h2>
          <button
            type="button"
      ...
      <div className="flex p-4">
        ...
        {args.map((arg) => (
          <button
            key={arg}
            className={clsx(
              "border rounded px-2 py-2 mr-4 mb-4 focus:outline-none focus:border-black hover:border-gray-400 transition duration-300 font-[400] font-sans text-sm",
              "dark:border-gray-700 dark:bg-gray-800 dark:text-white",
              selectedArgs.includes(arg) ? 'bg-gray-100 dark:bg-gray-700' : ''
            )}
