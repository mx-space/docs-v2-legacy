  ...
  <div className="features-container">
    <div className="content-container">
      <Features>
        ...
        <Feature index={4} centered className="feat-darkmode" style={{
          display: 'flex',
          alignItems: 'center',
        ...
        <Feature index={6} large id="search-card" href="/docs">
          <div style={{ zIndex: 2}}>
            <h3>PTY 支持, <br/>在浏览器中使用终端。</h3>
            <p>Mix Space 支持在浏览器中使用终端，您可以在后台使用终端来管理您的 Mix Space。</p>
          </div>
          ...
          <img src="/pty.png" className="absolute w-full h-full inset-0 object-cover object-right-top z-0"/>
        </Feature>
        <Feature index={2} large id="serverless-card" style={{
          color: 'white',
          ...
          云函数模块，<br className="show-on-mobile" />让服务端更易拓展。可以实现歌单解析，追番列表等。
          </h3>
        </Feature>
        <Feature index={3} id="analyze-card" className='card-with-border' style={{
          backgroundSize: 720,
          backgroundRepeat: 'no-repeat',
          minHeight: 288,
        ...
        <Feature index={5}>
          <h3>实时日志</h3>
          <p>Mix Space 支持实时日志，您可以在后台查看您的 Mix Space 的实时运行日志。</p>
        </Feature>
