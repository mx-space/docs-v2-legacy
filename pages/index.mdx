...
<style jsx>{`
  ...
  :global(#macros-card) {
    min-height: 300px;
    background-image: linear-gradient(to top, transparent, #fff 50%), url(/macros.png);
    background-size: 634px;
    background-position: -6px calc(100% + 30px);
    background-repeat: no-repeat;
  }
  :global(.dark #macros-card) {
    background-image: linear-gradient(to top, transparent, #202020 50%), url(/macros-dark.png);
  }
  :global(#pty-card) {
    display: flex;
  ...
  :global(#pty-card img:nth-child(2)) {
    display: none;
  }
  :global(.dark #pty-card img:nth-child(2)) {
    display: initial;
  }
  :global(.dark #pty-card img:nth-child(1)) {
    display: none;
  }
  ...
  <div className="features-container">
    <div className="content-container">
      <Features>
        ...
        <Feature index={3} id="macros-card" href="/docs">
          <div style={{ zIndex: 2}}>
            <h3>自定义 MD 语法支持, <br/>丰富您的内容。</h3>
        ...
        <Feature index={4}>
          ...
          <p>Mix Space 的友链系统强大且全面，在后台你可以检测你的老友是否还「健在」。<br /><i>通过、等待、过时、拒绝、封禁</i>，友链一切尽在掌握。</p>
        </Feature>
        
        <Feature index={5} large id="serverless-card" style={{
          color: 'white',
